...
window.location='http://localhost/project/print/page.php';
	...
	$Tipo = '';
	    ...
	    if(isset($_POST['save']))
	    {
	    	...
	    	$mysqli->query("INSERT INTO azienda (NomeA, N_Telefono, Email, Indirizzo, Città, Tipo) VALUES('$NomeA', '$N_Telefono', '$Email', '$Indirizzo', '$Città', '$Tipo')") or 
	    		die($mysqli->error);

	   		$_SESSION['message'] = "Azienda salvata";
	   		$_SESSION['msg_type'] = "success";

	   		header("location: i_azienda.php");
	    }
	    ...
	    if (isset($_GET['edit']))
	    {
	    	...
	    	$update = true;
			$result = $mysqli->query("SELECT * FROM azienda WHERE NomeA='$NomeA'") or die ($mysqli->error());
