...
<body>
	<div align ="center" class="barra"><br>&nbsp&nbsp
	    ...
	    &nbsp&nbsp
	    <a href="http://localhost/project/print/stampa_stage.php" title="Stampa"><img src="../img/stampa.png" width="25px" height="25px"></a>&nbsp&nbsp&nbsp&nbsp
	    &nbsp&nbsp
	...
	<center>
    	...
    	<h1><b>STAGE</b></h1>
	        ...
	        <form action="c_stage.php" method="GET">
