	...
	<body>
		<div align ="center" class="barra"><br><br>
			<div class="aP">
				...
				&nbsp&nbsp
				<a href="http://localhost/project/edit/stage/i_stage.php?" title="Torna indietro"><img src="../img/arrow_back.png" width="25px" height="25px"></a>&nbsp&nbsp&nbsp&nbsp
				&nbsp&nbsp
				<a href="http://localhost/project/print/stampa_az.php" title="Stampa"><img src="../img/stampa.png" width="25px" height="25px"></a>&nbsp&nbsp&nbsp&nbsp
				&nbsp&nbsp
		...
		<?php require_once 'p_stage.php'; 
			...
			echo '
			<form action="p_stage.php" method="POST">
				<input type="text" name="Cod_Stage" value=" '.$Cod_Stage .'" placeholder="codice stage">	
				<input type="text" name="Durata" value=" '. $Durata .'" placeholder="numero di ore">	
				<input type="text" name="Anno" value=" '. $Anno .'" placeholder="anno svolgimento">	
			...
			$azienda = isset($_GET['Azienda']);
			$matricola = isset($_GET['Matricola']);
			$ore = isset($_GET['Ore']);
			$citta = isset($_GET['Città']);
			$tipo = isset($_GET['Tipo']);
		

			$mysqli = new mysqli('127.0.0.1', 'root', '', 'pcto') or die(mysqli_error($mysqli));
			$result =$mysqli->query("SELECT * FROM stage") or die($mysqli->error);
			...
			echo "<table>
				<thead>
					<tr>
						<th width=''>CODICE STAGE</th>
						<th width='200'>DURATA</th>
						<th width='125'>ANNO</th>
						<th width='260'>NOME AZIENDA</th>
						<th width=''>MATRICOLA</th>
					</tr>
				</thead>
			...
			{  
				...
				echo "<td style='border-bottom: 1px solid #000000'>
								<a href='i_stage.php?edit= ".$row['Cod_Stage']."'>edit</a>
								<a href='p_stage.php?delete=".$row['Cod_Stage']."'>delete</a>	
							</td>
						</tr> ";
			}
